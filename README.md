...
1. [배열 실습 문제](#배열-실습-문제)
2. [컬렉션 실습 문제](#컬렉션-실습-문제)
3. [HashMap을 이용한 연락처 관리 프로그램](#hashmap을-이용한-연락처-관리-프로그램)
...
**List**, **Set**, **Map** 등의 컬렉션을 사용하여 데이터를 저장하고 처리하며, 각 컬렉션의 특성과 효율적인 활용 방법을 실습했습니다.

#### 사용된 기술
- **Java**
- **ArrayList, HashSet, HashMap (컬렉션 프레임워크)**
...
- **List**, **Set**, **Map** 각각의 특성과 그에 적합한 사용 사례를 파악하고, 실제 문제에 어떻게 적용할 수 있는지를 실습했습니다.
  
#### 학습 성과
- **ArrayList**를 사용한 순차적 데이터 관리와 검색에 대한 이해.
- **HashSet**을 사용하여 중복된 데이터를 필터링하고 집합 연산을 처리하는 방법.
...
이 프로젝트들은 모두 Java의 기본적인 자료 구조와 알고리즘을 활용하여 데이터를 처리하고 관리하는 방법을 익히는 데 중점을 두었습니다. 각 프로젝트에서 배열, 컬렉션, HashMap을 사용하여 다양한 데이터 관리 및 처리 방법을 실습했습니다. Big Data 수업에서 배운 이론을 바탕으로 실제 구현 경험을 쌓을 수 있었으며, 향후 대규모 데이터 처리 및 분석에도 유용한 기술적 기초가 되었습니다.
