...
#print(f'X shape : {X.shape}')
#print(f'y shape : {y.shape}')
#print(f'np.bincount(y) : {np.bincount(y)}')

# under sample
from imblearn.under_sampling import RandomUnderSampler
rus=RandomUnderSampler(random_state=42)
X_under_resampled, y_under_resampeld = rus.fit_resample(X,y)
print(np.bincount(y_under_resampeld))
# over sample
from imblearn.over_sampling import SMOTE
smote=SMOTE(random_state=1)
X_over_resampled,y_over_resampeld =smote.fit_resample(X,y)
print(np.bincount(y_over_resampeld))
```
