...
# [Input Layer]
#      ↓
# [Hidden Layer 1] → activate_function (예: sigmoid, ReLU, sortmax)
#      ↓
# [Hidden Layer 2] → activate_function (예: sigmoid, ReLU, sortmax)
#      ↓
# [Output Layer]   → activate_function = softmax (다중 분류일 경우)
