...
- 이때 odds는 \( \frac{0.75}{0.25} = 3 \)입니다.

즉, 사건이 발생할 확률이 발생하지 않을 확률에 비해 3배 더 클 수 있다는 의미입니다.

#### 2. 사건이 발생할 확률 \( P(A) = 0.2 \)일 때
- 사건이 발생하지 않을 확률은 \( 1 - 0.2 = 0.8 \)
- 이때 odds는 \( \frac{0.2}{0.8} = 0.25 \)입니다.
...
#### 주사위 던지기
- 주사위를 던졌을 때 숫자 6이 나올 확률 : \( \frac{1}{6} \)
- 6이 나오지 않을 확률 : \( 1 - \frac{1}{6} = \frac{5}{6} \)
...
즉, 주사위를 던졌을 때 숫자 6이 나올 확률은 5배 더 발생하지 않을 확률보다 낮다는 의미입니다.
